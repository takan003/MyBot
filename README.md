...
## 快速上手🚀 [[教學影片](https://youtu.be/S8jnl3WQo58)]
...
2. **設定4個共用連結**：
   ...
   - 當然，可以順便修改與填寫其他的設定項目。
3. **部署程式與執行**：打開主程式所在的試算表（我的聊天機器人_內含主程式_自由取名），在上方功能選單中找到擴充功能中的「Apps Script」，利用右上角部署按鈕，將程式部署為「網頁應用程式」，執行身分為「我」，誰可以存取「所有人」，部署好後取得上面的網址就能執行了。
